...
export const TagUpdate = (props: ITagUpdateProps) => {
  ...
  const { tagEntity, users, notes, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="noteyApp.tag.home.createOrEditLabel">
            <Translate contentKey="noteyApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="tag-name">
                  <Translate contentKey="noteyApp.tag.name">Name</Translate>
                </Label>
                <AvField id="tag-name" type="text" name="name" />
              </AvGroup>
              <AvGroup>
                <Label for="tag-assignedTo">
                  <Translate contentKey="noteyApp.tag.assignedTo">Assigned To</Translate>
                </Label>
                <AvInput id="tag-assignedTo" type="select" className="form-control" name="assignedTo.id">
                  <option value="" key="0" />
                  {users
