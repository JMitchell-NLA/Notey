...
export const Note = (props: INoteProps) => {
  ...
  return (
    <div>
      <h2 id="note-heading">
        <Translate contentKey="noteyApp.note.home.title">Notes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="noteyApp.note.home.createLabel">Create new Note</Translate>
        </Link>
      </h2>
        ...
        {noteList && noteList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="noteyApp.note.content">Content</Translate>
                </th>
                <th>
                  <Translate contentKey="noteyApp.note.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="noteyApp.note.xpos">Xpos</Translate>
                </th>
                <th>
                  <Translate contentKey="noteyApp.note.ypos">Ypos</Translate>
                </th>
                <th>
                  <Translate contentKey="noteyApp.note.assignedTo">Assigned To</Translate>
                </th>
                <th>
                  <Translate contentKey="noteyApp.note.tag">Tag</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="noteyApp.note.home.notFound">No Notes found</Translate>
            </div>
          )
        )}
      </div>
