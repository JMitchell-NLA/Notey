...
import net.kooksdoes.NoteyApp;

import net.kooksdoes.config.Constants;
import net.kooksdoes.config.TestSecurityConfiguration;
import net.kooksdoes.config.audit.AuditEventConverter;
import net.kooksdoes.domain.PersistentAuditEvent;
...
import static net.kooksdoes.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = {NoteyApp.class, TestSecurityConfiguration.class})
@Transactional
